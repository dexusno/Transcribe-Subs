...
def _llm_cleanup_pass(
    ...
    *,
    ...
    system_prompt = (
        ...
        "\n"
        "PRIORITY: Fix misheard words. Speech recognition often produces\n"
        "words that SOUND similar to what was said but are WRONG.\n"
        "You MUST read each line carefully and ask: does this make sense?\n"
        "Use the surrounding lines for context — they are continuous dialogue.\n"
        "If characters are discussing a topic, use that context to understand\n"
        "what words were actually spoken.\n"
        "If a word or phrase sounds right but makes no sense in context,\n"
        "replace it with what was actually said.\n"
        "Think about what SOUNDS similar but is the CORRECT word.\n"
        "A wrong word will sound almost identical to the right one when spoken.\n"
        "\n"
        "Also fix:\n"
        ...
        "\n"
        "Do NOT remove dialogue that is correct.\n"
